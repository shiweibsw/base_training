...
class Training_Node_CheckCircle {
    ...
    private boolean checkCircle28(Node head) {
    ...
    private boolean checkCircle27(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle18(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle19(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle20(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle21(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
    ...
    private boolean checkCircle22(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle23(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
    ...
    private boolean checkCircle24(Node head) {
        if (head == null) return false;
        Node fast = head.next;
        Node slow = head;
        while (fast != null && fast.next != null) {
