...
class Training_Node_Check_Intersection {
    ...
    private Node checkIntersection5(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
    ...
    private Node checkIntersection6(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
    ...
    private Node checkIntersection7(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
    ...
    private Node checkIntersection9(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
    ...
    private Node checkIntersection10(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
    ...
    private Node checkIntersection11(Node l1, Node l2) {
        Node n1 = l1;
        Node n2 = l2;
        while (n1 != n2) {
            n1 = n1 == null ? l2 : n1.next;
